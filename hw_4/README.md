...
## Создаём сеть и поднимаем docker compose
конфиг rsConfig (cfg1–cfg3, порты 27001–27003); два шарда  — rsShard1 (sh1n1–sh1n3, 27011–27013) и rsShard2 (sh2n1–sh2n3, 27021–27023); два mongos (27000 и 27010)
~~~sh
